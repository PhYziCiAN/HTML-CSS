    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
           ...
           ?>
                <p><i class="fa fa-<?=$icons[$key]?> fa-fw w3-margin-right w3-large w3-text-teal"></i><?=$value?></p>
           <?php endforeach;?>
    ...
    <div class="w3-twothird">
        ...
        $array = [
                [
                    ...
                    'date' => 'Jan 2015 - <span class="w3-tag w3-teal w3-round">Current</span>',
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?=$array[0]['name']?> </b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$array[0]['date']?></h6>
          <p>Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?=$array[1]['name']?></b></h5>
